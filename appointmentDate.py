...
class WindowForappDate:
    def __init__(self, appD,staffID):
        ...
        # See future weeks and startdates (from Monday)
        ...
        self.lw1 = Label(self.appD, text="Week "+ str(self.w1) + "     Start date: "+ str(start_w1)+
                                         "   * You cannot add those dates within 7 days. ", font=self.f1, fg='black', bg='pink')
        self.lw1.place(x=0, y=330)
        self.lw2 = Label(self.appD, text="Week "+ str(self.w2) + "     Start date: "+ str(start_w2), font=self.f1, fg='black', bg='pink')
        self.lw2.place(x=0, y=360)
        self.lw3 = Label(self.appD, text="Week "+ str(self.w3) + "     Start date: "+ str(start_w3), font=self.f1, fg='black', bg='pink')
    ...
    def seecal(self):
        ...
        try :
            ...
            if m not in range(1,13) :
                ...
                root11 = Tk()
                root11.title("Monthly Calendar")
                # pick a fixed font like courier so spaces behave right
                output = Label(root11, text=str1, font=('courier',14),justify=LEFT, bg='lightgreen')
    ...
    def drViewAvailableDate(self):
        ...
        rootviewAvail = Tk()
        r11 = WindowForViewAvail(rootviewAvail, self.staffID)
